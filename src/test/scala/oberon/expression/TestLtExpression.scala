...
class TestLtExpression extends FlatSpec with Matchers with GivenWhenThen with BeforeAndAfter {

  behavior of "a lt expression"
  ...
  it should "return value false in Lt(IntValue(5), Add(IntValue(3), IntValue(3))))" in {
    val val5 = IntValue(5)
    val val3 = IntValue(3)
  ...
  it should "return value true in Lt(IntValue(10), Add(IntValue(3), IntValue(3))))" in {
